  ...
  return (
    <View style={s.passwordContainer}>
      <View style={s.passwordCard}>
        ...
        <TouchableOpacity style={s.unlockBtn} onPress={handleSubmit}>
...
export default function AdminPanelTab() {
  ...
  }, [isUnlocked, fetchBuses, fetchDrivers, fetchAnnouncement]);
  ...
  const saveBusComment = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/admin/buses/${commentBusId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
    ...
    <View style={s.container}>
      ...
      <View style={s.announcementSection}>
        <Text style={s.announcementLabel}>
          <Ionicons name="megaphone" size={16} color="#e65100" /> Announcement
          for all buses
        </Text>
        ...
        <View style={s.announcementActions}>
          ...
          <TouchableOpacity
            style={[
              s.saveAnnouncementBtn,
              savingAnnouncement && { opacity: 0.6 },
            ]}
        ...
        {announcement ? (
          <Text style={s.currentAnnouncement}>Current: "{announcement}"</Text>
        ) : null}
      </View>
